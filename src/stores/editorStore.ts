...
export interface EditorState {
  ...
  editorSidebarTab: 'properties' | 'behaviour' | 'layers' | 'variables' | 'preview' | 'history' | 'comments' | 'activity' | 'reviews'
  ...
  setEditorSidebarTab: (tab: 'properties' | 'behaviour' | 'layers' | 'variables' | 'preview' | 'history' | 'comments' | 'activity' | 'reviews') => void
