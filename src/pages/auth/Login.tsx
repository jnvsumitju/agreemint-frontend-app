      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 rounded-lg border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              ...
              <div className="flex gap-2">
                {providers?.google && (
                  <a
                    ...
                    className="flex flex-1 items-center justify-center gap-2 rounded-md border border-zinc-300 px-3 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-50 dark:border-zinc-600 dark:text-zinc-200 dark:hover:bg-zinc-800"
                  >
          ...
          <div className="flex items-center justify-between text-sm">
            <Link to="/forgot-password" className="text-violet-600 hover:underline dark:text-violet-400">Forgot password?</Link>
            <Link to="/register" className="text-violet-600 hover:underline dark:text-violet-400">Create account</Link>
          </div>
        </form>
      </div>
    </div>
