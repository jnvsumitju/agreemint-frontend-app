      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 rounded-lg border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <>
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="bg-white px-2 text-zinc-500 dark:bg-zinc-900 dark:text-zinc-400">or sign up with</span>
                </div>
              </div>
          ...
          <p className="text-center text-sm text-zinc-500 dark:text-zinc-400">
            ...
            <Link to="/login" className="text-violet-600 hover:underline dark:text-violet-400">Sign in</Link>
          </p>
        </form>
      </div>
    </div>
