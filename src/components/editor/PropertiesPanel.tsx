...
function DocumentPageSection() {
  ...
  const field = (side: keyof typeof m, label: string) => (
    <label key={side} className="flex flex-col gap-0.5 text-[11px]">
  ...
  return (
    <div className="rounded-lg border border-zinc-200 bg-zinc-50/80 p-2.5 dark:border-zinc-600 dark:bg-zinc-900/40">
      <p className="mb-1 text-xs font-semibold uppercase tracking-wide text-zinc-500">Document</p>
      ...
      <div className="rounded-lg border border-violet-200 bg-violet-50/80 p-3 dark:border-violet-800 dark:bg-violet-950/30">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          <button
            ...
            className="rounded-md border border-violet-300 bg-white px-2.5 py-1.5 text-[11px] font-medium text-violet-900 hover:bg-violet-100 disabled:cursor-not-allowed disabled:opacity-40 dark:border-violet-600 dark:bg-violet-900/40 dark:text-violet-100 dark:hover:bg-violet-900/70"
          ...
          <button
            ...
            className="rounded-md border border-zinc-300 bg-white px-2.5 py-1.5 text-[11px] font-medium text-zinc-800 hover:bg-zinc-50 disabled:cursor-not-allowed disabled:opacity-40 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100 dark:hover:bg-zinc-700"
          ...
          <button
            type="button"
            className="rounded-md border border-red-200 bg-white px-2.5 py-1.5 text-[11px] font-medium text-red-700 hover:bg-red-50 dark:border-red-900 dark:bg-red-950/30 dark:text-red-300 dark:hover:bg-red-950/50"
...
function BehaviourBody() {
  ...
  return (
    <div className="flex flex-col gap-3 p-3">
      {!bandEditorMode ? <DocumentPageSection /> : null}
      <h2 className="text-xs font-semibold uppercase tracking-wide text-zinc-500">Behaviour</h2>
      ...
      {el.groupId && (
        <div className="rounded-lg border border-zinc-200 bg-zinc-50/90 p-3 dark:border-zinc-600 dark:bg-zinc-800/50">
          <p className="text-xs font-medium text-zinc-700 dark:text-zinc-200">Grouped</p>
          <p className="mt-1 text-[11px] leading-snug text-zinc-600 dark:text-zinc-400">
      ...
      {el.type === 'RING' && (
        <div className="rounded-lg border border-zinc-200 p-3 dark:border-zinc-600">
          <p className="mb-2 text-xs font-medium text-zinc-700 dark:text-zinc-200">Ring</p>
          <label className="flex flex-col gap-1 text-xs">
      ...
      {el.type === 'TABLE' && (
        <div className="flex flex-col gap-3 rounded-lg border border-zinc-200 p-3 dark:border-zinc-600">
          <p className="text-xs font-medium text-zinc-700 dark:text-zinc-200">Table data</p>
          ...
          <label className="flex flex-col gap-1 text-xs">
            ...
            <input
              ...
              type="text"
              className="rounded border border-zinc-300 px-2 py-1 font-mono text-sm dark:border-zinc-600 dark:bg-zinc-800"
              value={el.dataKey ?? ''}
              onChange={(e) => {
          ...
          <div className="flex flex-col gap-2">
            <p className="text-[11px] font-medium text-zinc-600 dark:text-zinc-400">Columns</p>
            ...
            {(el.columns ?? []).map((col, ci) => (
              ...
              >
                ...
                <button
                  ...
                  className="mt-2 text-[11px] text-red-600 hover:underline disabled:cursor-not-allowed disabled:opacity-40 dark:text-red-400"
            ...
            <button
              type="button"
              className="self-start rounded-md border border-zinc-300 bg-white px-2.5 py-1.5 text-[11px] font-medium text-zinc-800 hover:bg-zinc-50 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100 dark:hover:bg-zinc-700"
    ...
    return (
      <div className="flex flex-col gap-3 p-3">
        ...
        <div className="rounded-lg border border-zinc-200 bg-zinc-50/90 p-3 dark:border-zinc-600 dark:bg-zinc-800/50">
          ...
          <button
            type="button"
            className="mt-2 rounded-md border border-violet-300 bg-white px-2.5 py-1.5 text-[11px] font-medium text-violet-900 hover:bg-violet-50 dark:border-violet-600 dark:bg-violet-900/40 dark:text-violet-100 dark:hover:bg-violet-900/70"
  ...
  return (
    <div className="flex flex-col gap-3 p-3">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-xs font-semibold uppercase tracking-wide text-zinc-500">Layout</h2>
        {showLayoutDelete ? (
          <button
            type="button"
      ...
      <p className="text-xs text-zinc-600 dark:text-zinc-400">Type: {el.type}</p>
      ...
      <div className="grid grid-cols-2 gap-x-3 gap-y-2">
        <label className="flex min-w-0 flex-col gap-1 text-xs">
          ...
          <input
            ...
            type="number"
            className="min-w-0 rounded border border-zinc-300 px-2 py-1 text-sm dark:border-zinc-600 dark:bg-zinc-800"
      ...
      {el.type === 'TABLE' && (
        <div className="flex flex-col gap-3 border-t border-zinc-200 pt-3 dark:border-zinc-600">
          ...
          <div className="flex flex-col gap-2 rounded-md border border-zinc-200 bg-white/80 p-2 dark:border-zinc-600 dark:bg-zinc-900/50">
            <p className="text-[11px] font-medium text-zinc-700 dark:text-zinc-200">Table chrome (canvas)</p>
...
export function PropertiesPanel() {
  ...
  return (
    <aside className="flex w-96 min-w-0 shrink-0 flex-col border-l border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
      <div className="flex shrink-0 border-b border-zinc-200 dark:border-zinc-700">
        <button
          type="button"
          className={`flex-1 px-2 py-2.5 text-sm font-medium transition-colors sm:px-3 ${
            tab === 'properties'
